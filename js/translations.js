...
async function updatePageLanguage() {
  ...
  document.getElementById("headerTitle").textContent =
    "⎚ " + (trans.title || "FOV Calculator");
  document.getElementById("headerSubtitle").textContent = trans.subtitle || "";
  document.getElementById("screenRatioLabel").textContent =
    trans.screenRatio || "Screen Ratio";
  document.getElementById("screenSizeLabel").textContent =
    trans.screenSize || "Screen Size";
  const inchesUnitEl = document.getElementById("inchesUnit");
  if (inchesUnitEl)
    inchesUnitEl.textContent = trans.inches || trans.inches_unit || "inches";
  document.getElementById("distanceLabel").textContent =
    trans.distanceLabel || "Distance to Screen";
  ...
  if (distanceUnit) {
    ...
    if (inOpt)
      inOpt.textContent = trans.inches || trans.inches_unit || "inches";
  }
  document.getElementById("screenTypeLabel").textContent =
    trans.screenType || "Setup Type";
